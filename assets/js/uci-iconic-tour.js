class UciIconicTour extends HTMLElement {
  connectedCallback(){
    ...
    *{box-sizing:border-box}
    ...
    svg{position:absolute;left:0;bottom:-24px;width:100%;height:76%;overflow:visible}.ghost,.draw{fill:none;stroke-linecap:round;stroke-linejoin:round;vector-effect:non-scaling-stroke}.ghost{stroke:var(--ghost);stroke-width:3.2;opacity:.20}.stage .ghost.detail{opacity:0}.draw{stroke:var(--ink);stroke-width:3.35;stroke-dasharray:1;stroke-dashoffset:1;transition:stroke-dashoffset 1.5s cubic-bezier(.65,0,.2,1)}.draw.detail{stroke-width:2.5;transition-delay:.22s}.draw.accent{stroke:var(--accent);stroke-width:3.6;transition-delay:.45s}.s1 .ghost,.s1 .draw{filter:url(#rough1)}.s2 .ghost,.s2 .draw{filter:url(#rough2)}.s3 .ghost,.s3 .draw{filter:url(#rough3)}.s4 .ghost,.s4 .draw{filter:url(#rough4)}.s5 .ghost,.s5 .draw{filter:url(#rough5)}.s6 .ghost,.s6 .draw{filter:url(#rough6)}.connector{z-index:2;pointer-events:none}.connector .ghost{stroke-width:3.35;filter:url(#roughMain)}.hover-line{fill:none;stroke:var(--ink);stroke-width:3.35;stroke-linecap:round;stroke-linejoin:round;stroke-dasharray:1;stroke-dashoffset:1;filter:url(#roughMain);transition:stroke-dashoffset 1.25s cubic-bezier(.65,0,.2,1)}.tour:has(section:nth-of-type(1):hover) .hover-1,.tour:has(section:nth-of-type(1).active) .hover-1,.tour:has(section:nth-of-type(2):hover) .hover-2,.tour:has(section:nth-of-type(2).active) .hover-2,.tour:has(section:nth-of-type(3):hover) .hover-3,.tour:has(section:nth-of-type(3).active) .hover-3,.tour:has(section:nth-of-type(4):hover) .hover-4,.tour:has(section:nth-of-type(4).active) .hover-4,.tour:has(section:nth-of-type(5):hover) .hover-5,.tour:has(section:nth-of-type(5).active) .hover-5,.tour:has(section:nth-of-type(6):hover) .hover-6,.tour:has(section:nth-of-type(6).active) .hover-6{stroke-dashoffset:0}.shade{stroke:none;fill:var(--ink);opacity:0;transition:opacity .55s .35s ease}.stage:hover .shade,.stage.active .shade{opacity:.15}.hatch{fill:none;stroke:var(--ink);stroke-width:1.7;opacity:0;stroke-linecap:round;transition:opacity .55s .5s ease}.stage:hover .hatch,.stage.active .hatch{opacity:.34}
