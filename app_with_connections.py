...
// ── Tab navigation ────────────────────────────────────────────────────────
const _DASHBOARD_TABS = ['logos', 'riders', 'connections'];
...
// ── Connexions (placeholders — OAuth à brancher par plateforme) ──────────
function connClick(platform) {
  // À implémenter : ouvrir le flow OAuth de chaque plateforme
  alert(`Connexion ${platform} — à configurer avec les credentials OAuth de l'app.`);
}
